...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        ...
        axios.get('/nova-vendor/tips/endpoint').then(function (response) {

            _this.from = response.data;
        });
    },
    data: function data() {
        return {
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Tips")]),
      _vm._v(" "),
      _c(
        "card",
        {
        ...
        [
          ...
          _c("p", { staticClass: "text-white-50% text-lg" }, [
            ...
            _c(
              ...
              [_vm._v("/nova-components/Tips/resources/js/components/Tool.vue")]
            )
          ])
        ]
      )
