<template>
    <div>
        <heading class="mb-6">Tips</heading>
        ...
        <card class="bg-90 flex flex-col items-center justify-center" style="min-height: 300px">
            ...
            <p class="text-white-50% text-lg">
                ...
                <code class="ml-1 border border-80 text-sm font-mono text-white bg-black rounded px-2 py-1">/nova-components/Tips/resources/js/components/Tool.vue</code>
            </p>
        </card>
    </div>
</template>
...
//    },
    ...
    created() {
        axios.get('/nova-vendor/tips/endpoint')
             .then(response => {
